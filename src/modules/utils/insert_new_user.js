...
var DB = __importStar(require("./promiseDB"));
var insert_new_user;
insert_new_user = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var results, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                results = void 0;
                return [4 /*yield*/, DB.query('INSERT INTO users (id, point, if_attendance_check) VALUES (?, ?, ?)', [
                        id,
                        0,
                        false
                    ])];
...
exports.default = insert_new_user;
