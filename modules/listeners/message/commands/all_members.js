...
var all_members_1 = __importDefault(require("../../../utils/all_members"));
// let me =
// class Command {
// }
var all_members;
all_members = new Command_1.default({
    condition: function (msg) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, msg.content == "all_members"];
    }); }); },
    action: function (msg) { return __awaiter(void 0, void 0, void 0, function () {
        var cache;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, all_members_1.default(msg.channel.guild)];
                case 1:
                    cache = _a.sent();
                    cache.forEach(function (member) { return console.log(member.user.tag); });
                    return [2 /*return*/];
            }
        });
    }); },
