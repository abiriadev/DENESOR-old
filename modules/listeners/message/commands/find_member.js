...
// }
var find_member;
find_member = new Command_1.default({
    condition: function (msg) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, msg.content.slice(0, 12) == "find_member "];
    }); }); },
    action: function (msg) { return __awaiter(void 0, void 0, void 0, function () {
        var id, member;
        return __generator(this, function (_a) {
            id = msg.content.slice(12);
            console.log("ID: " + id);
            member = msg.channel.guild.members.cache.find(function (member) { return member.id == id; });
